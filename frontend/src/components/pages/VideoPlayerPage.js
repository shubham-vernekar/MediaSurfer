      ...
      <div className="video-player-box">
        ...
        <div className="video-player-details" >
          ...
          <div className="video-player-details-pane">
            ...
            <div className="player-review-button" onClick={() => {updateReview(!isReviewed)}}>
              {isReviewed && (
              ...
              {isReviewed && (
                <div className="review-text">Verfied</div>
              )}
              {!isReviewed && (
                <div className="review-text">Not Verfied</div>
              )}
            </div>
