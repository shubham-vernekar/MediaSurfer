import '../../../static/css/scrper/ScrpCastCard.css';
import { React } from "react";

function ScrpCastCard(props) {

  return (
    <div className="scrp-cast-card">
      <div className="scrp-poster">
        <a href={parseInt(props.pending)>0 ? "scrp/list?query=" + props.title : ''}><img className='scrp-poster-img' src={props.img} alt=""/></a>
