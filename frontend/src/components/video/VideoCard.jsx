    ...
    <div className="video-card" ref={videoCardRef} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
      ...
      <div className="advert-details" ref={videoDetailsRef}>
        ...
        <div className="video-advert-buttons-container">
          ...
          <div className='video-advert-button' onClick={handleOnClickDeleteButton} vidid={props.vidid}> 
            <svg className='video-advert-button-text-svg' width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
          ...
          <div className='video-advert-button' onClick={() => OpenFolder(props.vidid)}> 
            <svg className='video-advert-button-text-svg' width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
          ...
          {props.jtTrailerUrl && (<div className='video-advert-button' onClick={() => window.open(props.jtTrailerUrl)}> 
            <svg width="18" height="18" fill="currentColor" className="video-advert-button-text-svg" viewBox="0 0 16 16">
