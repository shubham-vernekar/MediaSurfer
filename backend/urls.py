...
urlpatterns = [
    ...
    path('real-debrid/delete', views.DeleteRealDebrid.as_view(), name='list-real-debrid'),
    path('debrid-files/open', views.OpenPlayerDebridView.as_view(), name='debrid-open-player'),
