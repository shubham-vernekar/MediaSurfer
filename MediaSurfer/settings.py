"""
Django settings for MediaSurfer project.
...
SECRET_KEY = 'django-insecure-fe(4)n2*4z*wsru$-dje4zeve%d&luik50v36awj5g57w6=gn+'
...
DATABASES={
   'default':{
      ...
      'NAME':'MediaSurfer',
      'USER':'postgres',
      'PASSWORD':'admin', # TODO move pin to more secure location
      'HOST':'localhost',
      'PORT':'5432',
   }
}
